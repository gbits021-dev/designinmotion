                ...
                <div className="flex gap-2">
                  ...
                  <label className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg cursor-pointer flex items-center whitespace-nowrap">
                    ...
                    <input
                      type="file"
                      accept="image/*"
                      onChange={(e) => handleImageUpload(e.target.files[0], "architectsClub.logo")}
                      className="hidden"
                      disabled={uploading}
                    />
                  </label>
            ...
            <div className="space-y-6">
              ...
              {editedContent.partners.map((partner, index) => (
                <div key={index} className="border border-gray-200 rounded-lg p-6 bg-gray-50">
                  <div className="flex justify-between items-center mb-4">
                    <h3 className="font-semibold text-gray-800 text-lg">Partner {index + 1}</h3>
                    <button
                      onClick={() => {
                        const newPartners = editedContent.partners.filter((_, i) => i !== index);
                  ...
                  <div className="space-y-4">
                      ...
                      <div className="grid md:grid-cols-2 gap-3">
                        <div>
                          ...
                          <textarea
                            ...
                            onChange={(e) => {
                              const newPartners = [...editedContent.partners];
                              if (!newPartners[index].description) {
                                newPartners[index].description = { en: "", ka: "" };
                              }
                              newPartners[index].description.en = e.target.value;
                              setEditedContent({ ...editedContent, partners: newPartners });
                            }}
                            rows="2"
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            value={partner.description?.ka || ""}
                            onChange={(e) => {
                              const newPartners = [...editedContent.partners];
                              if (!newPartners[index].description) {
                                newPartners[index].description = { en: "", ka: "" };
                              }
                              newPartners[index].description.ka = e.target.value;
                              setEditedContent({ ...editedContent, partners: newPartners });
                            }}
                            rows="2"
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                    ...
                    {/* Detailed Info (Long Text - for "More Info" section) */}
                    <div className="border-t border-gray-300 pt-4">
                      <label className="block text-sm font-medium text-gray-700 mb-2">Detailed Information (for "More Info" section)</label>
                      <div className="grid md:grid-cols-2 gap-3">
                        <div>
                          <label className="block text-xs font-medium text-gray-600 mb-1">English</label>
                          <textarea
                            placeholder="Detailed information about the partner..."
                            value={partner.detailedInfo?.en || ""}
                            onChange={(e) => {
                              const newPartners = [...editedContent.partners];
                              if (!newPartners[index].detailedInfo) {
                                newPartners[index].detailedInfo = { en: "", ka: "" };
                              }
                              newPartners[index].detailedInfo.en = e.target.value;
                              setEditedContent({ ...editedContent, partners: newPartners });
                            }}
                            rows="5"
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                        ...
                        <div>
                          <label className="block text-xs font-medium text-gray-600 mb-1">Georgian</label>
                          <textarea
                            placeholder="დეტალური ინფორმაცია პარტნიორის შესახებ..."
                            value={partner.detailedInfo?.ka || ""}
                            onChange={(e) => {
                              const newPartners = [...editedContent.partners];
                              if (!newPartners[index].detailedInfo) {
                                newPartners[index].detailedInfo = { en: "", ka: "" };
                              }
                              newPartners[index].detailedInfo.ka = e.target.value;
                              setEditedContent({ ...editedContent, partners: newPartners });
                            }}
                            rows="5"
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
