...
const content = {
  ...
  "event": {
    ...
    "venueDetailed": {
      "en": "Tbilisi Marriott Hotel, 13 Shota Rustaveli Ave, Tbilisi",
      "ka": "თბილისი მარიოტ ჰოთელი, შოთა რუსთაველის 13, თბილისი"
    },
  ...
  "hero": {
    ...
    "bannerImageMobile": "/1761209732896-mobile-2.jpg",
    "logoKa": "/dio-logo-ka.svg",
    "logoEn": "/dio-logo-en.svg",
    "title": {
      "en": "EFFICIENT ARCHITECTURE CONFERENCE - 2025 ",
      "ka": "ენერგოეფექტური არქიტექტურის კონფერენცია - 2025 "
    },
    "subtitle": {
  ...
  "agenda": [
    ...
    },
    {
      ...
      "description": {
        ...
        "ka": "კომპანიის გავლილი 30 წლიანი გზა და ახალი გამოწვევები"
      },
      "speaker": {
        "en": "",
        "ka": ""
  ...
  "about": {
    ...
    "footer": {
      "en": "Architects, designers, engineers & industry professionals.",
      "ka": "არქიტექტორებისთვის, დიზაინერებისთვის, ინჟინრებისთვის და ინდუსტრიის პროფესიონალებისთვის."
    }
  },
  "architectsClub": {
    "title": {
